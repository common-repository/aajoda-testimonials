...
function add_aajoda_scripts() {
	...
	if($version==="2.0"){
		...
		wp_register_script('aajoda_refsv20','https://az666548.vo.msecnd.net/misc/Aajoda_refsv2_2.min.js',null,null,false);
	}
...
/*
	function myfooterscript() {
		$output="<script> iFrameResize({log:true,heightCalculationMethod : 'max'}); </script>";
		return $output;
	}
	add_action( 'wp_footer', 'myfooterscript' );
*/
